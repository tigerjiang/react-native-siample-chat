        ...
        >
          {
            useVoice ? <View style={{ height: 35 + inputHeightFix, justifyContent: 'center', alignItems: 'center' }} activeOpacity={0.7}>
              <TouchableOpacity onPress={onMethodChange} activeOpacity={0.7}>
                {showVoice ? this.props.keyboardIcon ? this.props.keyboardIcon : <ImageComponent source={require('../source/keyboard.png')} style={{ width: 30, height: 30 }} /> : this.props.voiceIcon ? this.props.voiceIcon : <ImageComponent source={require('../source/voice.png')} style={{ width: 30, height: 30 }} />}
              </TouchableOpacity>
            </View> : null
          }
          <View style={{
